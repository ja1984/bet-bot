...
Sex matcher. Ny säsong = **ingen aggregat-logik, inga "must chase"-scenarier**. Det tar bort det starkaste normalverktyget, så alla confidence-tal hålls lågt (max 7/10) och analysen lutar sig mot form, skadeläge och hemmaplansstyrka.
...
### 🥇 Dortmund – Villarreal — kvällens bästa läsning
- **Dortmund:** 3 raka vinster, senast 3-2 mot Hoffenheim. Kovac.
- **Men försvarskrisen är brutal:** Schlotterbeck (fotled + avstängd), Bensebaini (avstängd), Emre Can (korsband), Lerma (muskel). Hela mittbackslinjen är ihopplockad — Gadou/Anton/Svensson.
- **Villarreal:** vinstlösa på 4 matcher (2 kryss, sedan förlust mot Alavés och 2-3 mot Depor), Íñigo Pérez ny tränare efter Marcelino. Vinstlösa i 7 raka CL-matcher. Foyth ute.
- Villarreal saknar resultat men **inte anfallskvalitet** — Mikautadze, Gerard Moreno, Nicolas Pepe. Ramverkets regel: kolla gjorda mål, inte bara tabellen.
- Senaste mötet: BVB 4-0 hemma (bara 1 datapunkt — ignoreras).

→ **Over 2.5 ⭐ 7/10** · **1H Over 0.5 7/10** · BTTS 6/10 · Dortmund vinst 6.5/10

### 🛡️ Porto – Man City — kvällens bästa defensiva läsning
- **Porto:** 6-7 raka vinster, **11-1 i målskillnad senaste fem**, bara 1 insläppt mål på sex matcher. Dragão är en riktig fästning.
- Men helt otestade — allt mot portugisisk liganivå. Bednarek avstängd, Froholdt (huvudskada) borta.
- **City:** Maresca, hans första CL-kampanj med City. Doku (vad) och O'Reilly (rygg) ute. 3-0-förlust mot Arsenal i Community Shield, sedan 2-1 Bournemouth och 4-1 Palace.
- Porto har **aldrig** slagit City i tävlingsmatch. Marciniak håller hårt i stora bortamatcher.
- Marknaden: City ~-140, Porto +360. Flera tipsters landar i 1-1.

→ **Under 2.5 ⭐ 6.5/10** · City vinst 6/10 · BTTS 5.5/10

### ⚖️ Real Madrid – Inter — kvällens affisch, men undvik resultatmarknaden
- **Mourinho** är tillbaka på Bernabéu. Sommarvärvningar: Bernardo Silva, Konaté, Cucurella, Dumfries.
- **Madrids frånvarolista är enorm:** Militão (hamstring), Rodrygo (knä), Mendy (hamstring), Asencio (skenben) ute. **Camavinga, Arda Güler OCH Bernardo Silva avstängda.** Tchouaméni, Endrick, Cucurella tveksamma.
- **Och de förlorade senast 0-1 hemma mot Betis** (4 sep). Ramverket: tappat senaste matchen + 2+ nyckelspelare borta = aldrig över 7/10 på vinst. Sätts till **5.5/10**.
...
- **Ramverksregel:** noll mål i 2+ raka matcher → **BTTS max 5/10**. Och "desperat utan tro = förlamning, inte energi" — Villa har inte vunnit på 6.
- **MEN:** Emery har 67% vinstprocent i CL med Villa, EL-mästare förra säsongen, och **9 nollor på 16 senaste UEFA-matcherna**. Villa är ett annat lag i Europa än i ligan.
- **Brugge:** 4 vinster på 5 i ligan, **mål i 25 raka matcher**, KO-fas tre år i rad. Bara Ordóñez skadad. Snittade 4.2 mål/match i CL förra säsongen — men släppte in nästan 2.

→ **Under 2.5 6.5/10** · **Brugge gör mål 7.5/10** · BTTS **5/10** · Villa vinst — rör inte

### 🔒 Lille – Betis
- **Lille:** Davide Ancelotti, obesegrad (2-0 Angers, 2-2 mot PSG, 1-0 Toulouse). Obesegrade i 7 av 9 senaste CL-matcher. Bara 1 förlust på 9 mot spanska lag. Giroud på topp.
- **Betis:** Pellegrini, **slog Real Madrid 1-0 senast**. Men mönstret är slående: 1-0, 1-0, 1-0 — plus en 2-5-smäll mot Levante. Första CL-matchen på 21 år. Llorente skadad, Abde sjuk.
- Tre 1-0-vinster + Lilles täta hemmaspel + CL-nervositet = lågt.

→ **Under 2.5 6.5/10** · Kryss 5.5/10 · BTTS 5/10

### 🇬🇷 AEK Aten – LASK — pott 4 mot pott 4
- **AEK:** obesegrade i 6, 5-0 mot Aris, 7p på 3 ligamatcher. **Varga: 6 mål på 4 matcher** (ett mål var 52:e minut).
- **LASK:** 5 raka ligavinster, vände 0-3 mot Celtic i kvalet. Första CL-gruppspelet på 60+ år.
- Två lag i toppform, men LASK:s CL-debut på en intensiv hemmaarena i Aten.

→ AEK vinst 6/10 · **AEK vinst eller kryss 7/10** · Over 2.5 6/10 · Varga mål 6/10

---

## 🎯 Kuponger — 300 kr

Diversifiering enligt ramverket: C1+C2 offensiva, **C3 defensiv hedge utan någon match som delas med C1/C2**, C4 blandad med säkert ben.

### 🔵 C1 — Ankare (100 kr)
**Dortmund–Villarreal Over 2.5** (7/10) + **AEK vinst eller kryss** (7/10)
> BVB:s ihopplockade försvar möter ett Villarreal som gör mål men inte vinner. AEK hemma, obesegrade i 6, mot en CL-debutant.

### 🟢 C2 — Huvudspel (80 kr)
**Dortmund–Villarreal 1H Over 0.5** (7/10) + **Real Madrid–Inter BTTS** (6.5/10)
> Signal Iduna Park startar aldrig långsamt. Inter är fullt friska och gör mål mot alla — Madrid har Mbappé/Vinícius kvar även utan halva mittfältet.

### 🔴 C3 — Hedge (80 kr) — helt oberoende av C1/C2
**Porto–Man City Under 2.5** (6.5/10) + **Club Brugge–Aston Villa Under 2.5** (6.5/10)
> Porto har släppt in 1 mål på sex matcher, City saknar Doku. Villa har inte gjort mål på tre matcher men håller nollan i Europa. Ingen match delas med ankaret.

### 🟡 C4 — Kul-trippel (40 kr)
**Brugge gör mål** (7.5/10 — säkra benet, 25 raka matcher) + **Lille–Betis Under 2.5** (6.5/10) + **Mbappé mål när som helst** (5.5/10)

---

## ⚠️ Medvetet undvikna spel
- **Real Madrid vinst** — 4 skadade + 3 avstängda + förlust senast. Klassisk 9/10-fälla.
- **Aston Villa vinst / Villa BTTS** — 0 mål på 3 matcher.
- **Dortmund BTTS i mer än ett spel** — hemmadominans dödar ofta BTTS även när målen kommer (bekräftat 11 & 18 mars).
- **Alla kuponger på samma tes** — det kostade 300 kr den 19 mars.

**Största risken i kväll:** C1 och C2 hänger båda på Dortmund–Villarreal — 60% av budgeten på en match, om än olika marknader i samma målriktning. Strängare alternativ: byt C2:s 1H-ben mot Porto–City Under 2.5.
